...
type ProfileInitialTab = 'listings' | 'bookings' | 'wishlist' | 'settings';

function parseInitialTab(value: string | undefined): ProfileInitialTab {
  if (value === 'bookings' || value === 'wishlist' || value === 'settings') {
    return value;
  }
